...
'''
import myplot.colorbar

from pylab import *
def set_shade(a,intensity=None,cmap=cm.jet,vmin=None,vmax=None,scale=10.0,azdeg=165.0,altdeg=45.0):
  ...
  # my modification
  cmap = myplot.colorbar.pseudo_transparent_cmap(cmap,0.8)  
